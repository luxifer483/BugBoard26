...
export const mockIssues = [
  ...
  },
  {
    id: 42,
    code: 'BUG-26-42',
    title: 'Add release checklist to sprint close workflow',
    description: 'The team needs a reusable release checklist so sprint closure is consistent across all deliveries.',
    type: 'FEATURE',
    priority: 'CRITICAL',
    status: 'IN_PROGRESS',
    ...
    updatedAt: '2026-03-30T09:05:00',
    attachmentUrl: '',
  },
  {
    id: 43,
    code: 'BUG-26-43',
    title: 'Update onboarding guide for the new issue workflow',
    description: 'The internal documentation still describes the previous flow and should be aligned with the current project dashboard.',
    type: 'DOCUMENTATION',
    priority: 'LOW',
    status: 'CLOSED',
    ...
    updatedAt: '2026-03-25T16:40:00',
    attachmentUrl: '',
  },
  {
    id: 44,
    code: 'BUG-26-44',
    title: 'Clarify expected behavior for archived projects',
    description: 'The product team asked for a decision on whether archived projects should still expose read-only issue details.',
    type: 'QUESTION',
    priority: 'MEDIUM',
    status: 'OPEN',
